"use strict"; // SOURCES/SERVER/holism/services/get-html-view-admin-control-panel.js
//
...
var factoryResponse = holism.service.create({
  ...
  handlers: {
    request_handler: function request_handler(request_) {
      ...
      while (!inBreakScope) {
        inBreakScope = true;
        var filterResponse = void 0; // To access the admin control panel you must be logged in a member of the app's owning organization.
